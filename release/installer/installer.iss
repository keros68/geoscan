...
; Setup Compiler (ISCC.exe installer.iss) to produce dist\installer\MapGISVectorizeSetup.exe
;
; Design notes (see release/README.md):
;  - Installs to Program Files (ASCII path -> ogr2ogr GDAL_DATA is happy).
;  - User config lives in %LOCALAPPDATA%\MapGISVectorize\config (written by the
...
DefaultDirName={autopf}\MapGISVectorize
DefaultGroupName=MapGIS 矢量化
DisableProgramGroupPage=yes
OutputDir=..\..\dist\installer
OutputBaseFilename=MapGISVectorizeSetup
...
[Icons]
Name: "{group}\MapGIS 矢量化"; Filename: "{app}\{#AppExe}"
Name: "{group}\卸载 MapGIS 矢量化"; Filename: "{uninstallexe}"
Name: "{autodesktop}\MapGIS 矢量化"; Filename: "{app}\{#AppExe}"; Tasks: desktopicon
...
Filename: "{app}\{#AppExe}"; Description: "启动 MapGIS 矢量化"; Flags: nowait postinstall skipifsilent
